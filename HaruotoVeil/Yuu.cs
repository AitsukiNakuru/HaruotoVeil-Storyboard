...
{
    public class Yuu : StoryboardObjectGenerator
    {
        public override void Generate()
        {
            var backgroundLayer = GetLayer("YuuBackground");
            var fgLayer = GetLayer("YuuBody");

            string bgPath = "sb/fg/yuu/bg.png";
            ...
            string fg1Path = "sb/fg/yuu/01.png";
